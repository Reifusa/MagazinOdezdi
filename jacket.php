...
<body style="background-color: #FFF;">
    ...
    <table  style="display: flex;">
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет1'";
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет2'"; 
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет3'"; 
        ...
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет4'"; 
             $all3 = mysqli_query($db, $queryALL); 
             $all3 = mysqli_fetch_assoc($all3); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет5'"; 
             $all4 = mysqli_query($db, $queryALL); 
             $all4 = mysqli_fetch_assoc($all4); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет6'"; 
        ...
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет7'"; 
             $all6 = mysqli_query($db, $queryALL); 
             $all6 = mysqli_fetch_assoc($all6); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет8'"; 
             $all7 = mysqli_query($db, $queryALL); 
             $all7 = mysqli_fetch_assoc($all7); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Джекет9'"; 
