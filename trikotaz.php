...
<body style="background-color: #FFF;">
    ...
    <table  style="display: flex;">
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж1'";
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж2'"; 
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж3'"; 
        ...
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж4'"; 
             $all3 = mysqli_query($db, $queryALL); 
             $all3 = mysqli_fetch_assoc($all3); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж5'"; 
             $all4 = mysqli_query($db, $queryALL); 
             $all4 = mysqli_fetch_assoc($all4); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж6'"; 
        ...
        <tr style="display: flex;">
            ...
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж7'"; 
             $all6 = mysqli_query($db, $queryALL); 
             $all6 = mysqli_fetch_assoc($all6); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж8'"; 
             $all7 = mysqli_query($db, $queryALL); 
             $all7 = mysqli_fetch_assoc($all7); 
            ?>
            <?php
             $queryALL = "SELECT * FROM `tovar` where `tovar`.`id тип`='Трикатаж9'"; 
