    ...
    <div style="display: inline-block; width: 1440px; margin-top: 100px; margin-left: 200px;" data-ignore="used only for top most containter width">
      <div class="login-container">
        <p class="login-title">Регистрация</p>
          <form method="post" action="lib/registr.php">
            <div class="registration-form">
              <div class="postal-address-container1">
                <p class="postal-address">Почтовый адрес</p>
                <input type="text" name="Почта" class="postal-address-container" style="font-size: large;">
              </div>
              <div class="password-container">
                <p class="postal-address">Пароль</p>
                <input type="password" name="Пароль" class="postal-address-container" style="font-size: large;">
              </div>
              <div class="password-container">
                <p class="postal-address">Повторите пароль</p>
                <input type="password" name="Парольроль" class="postal-address-container" style="font-size: large;">
              </div>
              <div class="account-creation-button">
                <div class="border-box-container"></div>
              </div>
              <button class="login-container2" type="submit">
                <p class="login-title1">Зарегистрировать</p>
              </div>
              <div class="registration-message">
                <div class="container-with-border"></div>
              </div>
              <p class="registration-message1">У вас уже есть аккаунт?</p>
              <a href="login.php"><div class="create-account-container">
                <p class="postal-address">Войти в аккаунт</p>
              </div></a>
            </div>
          </form>
      </div>
